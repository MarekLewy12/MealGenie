    ...
    >
      ...
      <div className="absolute right-3 top-3 flex items-center gap-2">
        ...
        <button
          ...
          className="cursor-pointer rounded-full bg-red-50 px-2.5 py-1 text-xs font-semibold text-red-600 transition hover:bg-red-100 disabled:cursor-not-allowed disabled:opacity-60 dark:bg-red-500/10 dark:text-red-400 dark:hover:bg-red-500/20"
